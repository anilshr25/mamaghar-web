...
class SiteSetting extends Model
{
    ...
    public function getFavIconPathAttribute()
    {
        ...
        if (!empty($this->fav_icon)) {
            $imagePath = getFilePath($this->uploadPath, $this->fav_icon);
        }
        return $imagePath;
    }
    ...
    public function getLogoPathAttribute()
    {
        $imagePath = [];
        if (!empty($this->logo)) {
            $imagePath = getFilePath($this->uploadPath, $this->logo);
        }
        return $imagePath;
    }
    ...
    public function getEmailLogoPathAttribute()
    {
        ...
        if (!empty($this->email_logo_image)) {
            $imagePath = getFilePath($this->uploadPath, $this->email_logo_image);
        }
        return $imagePath;
    }
    ...
    public function getFooterLogoPathAttribute()
    {
        ...
        if (!empty($this->footer_logo)) {
            $imagePath = getFilePath($this->uploadPath, $this->footer_logo);
        }
        return $imagePath;
    }
    ...
    public function getAppLogoPathAttribute()
    {
        ...
        if (!empty($this->app_logo)) {
            $imagePath = getFilePath($this->uploadPath, $this->app_logo);
        }
        return $imagePath;
    }
    ...
    public function getLoginBgPathAttribute()
    {
        ...
        if (!empty($this->login_bg_image)) {
            $imagePath = getFilePath($this->uploadPath, $this->login_bg_image);
        }
        return $imagePath;
    }
}
