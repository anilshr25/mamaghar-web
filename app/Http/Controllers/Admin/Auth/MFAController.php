...
class MFAController extends Controller
{
    ...
    function __construct(AdminUserService $user, GoogleAuthenticator $authenticator)
    {
        $this->user = $user;
    ...
    function deactivateEmailAuthenticator($id = null)
    {
        try {
            if($id == null) {
                $user = auth()->guard('admin')->user();
    ...
    function deactivateMfaAuthenticator($id = null)
    {
        if($id == null) {
            $user = auth()->guard('admin')->user();
        }else {
    ...
    public function resetMfaAuthenticator($id)
    {
        return $this->deactivateMfaAuthenticator($id);
    }

    public function resetEmailAuthenticator($id)
    {
        return $this->deactivateEmailAuthenticator($id);
    }
}
